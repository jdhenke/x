...
(define global (list
                 (list
                   ...
                   (list (symbol "<") 18)
                   (list (symbol "-") 19)
                   (list (symbol "string->number") 20)
                   (list (symbol "string-number?") 21)
                   (list (symbol "symbol") 22)
                   (list (symbol "boolean?") 23)
                   (list (symbol "number?") 24)
                   (list (symbol "string?") 25)
                   (list (symbol "list?") 26)
                   (list (symbol "symbol?") 27)
                   (list (symbol "function?") 28)
                   (list (symbol "length") 29)
                   (list (symbol "number->string") 30)
                   (list (symbol "string-length") 31)
