...
(map println '(
  ...
  (define list->vector/cps (to-cps list->vector))
  (define list?/cps (to-cps list?))
  (define make-random-state/cps (to-cps make-random-state))
  (define make-vector/cps (to-cps make-vector))
  ...
  (define vector->list/cps (to-cps vector->list))
  (define vector-length/cps (to-cps vector-length))
  (define vector-ref/cps (to-cps vector-ref))
  (define vector-set!/cps (to-cps vector-set!))
  (define vector?/cps (to-cps vector?))
